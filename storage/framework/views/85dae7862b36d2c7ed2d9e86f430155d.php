<?php $__env->startSection('title', 'Import Resume - AI Resume Builder'); ?>

<?php $__env->startSection('content'); ?>
<div class="min-h-screen bg-slate-950 text-slate-100 py-16 px-6">
    <div class="max-w-xl mx-auto">
        <a href="<?php echo e(route('resume.templates')); ?>" class="text-slate-400 hover:text-white transition inline-block mb-6">&larr; Back to Templates</a>
        ...
        <form action="<?php echo e(route('resume.import.store')); ?>" method="POST" enctype="multipart/form-data" id="import-form" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\OneDrive\Desktop\Resume Ai Builder\resources\views/resume/import.blade.php ENDPATH**/ ?>