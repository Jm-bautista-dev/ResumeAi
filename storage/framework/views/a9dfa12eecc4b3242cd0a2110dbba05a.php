...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Resume AI Builder'); ?></title>
...
<body class="antialiased bg-slate-900 text-gray-100">
    <div id="app" class="flex flex-col min-h-screen">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <?php echo $__env->make('components.navbar-auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php else: ?>
...
<?php /**PATH C:\Users\Admin\OneDrive\Desktop\Resume Ai Builder\resources\views/layouts/app.blade.php ENDPATH**/ ?>