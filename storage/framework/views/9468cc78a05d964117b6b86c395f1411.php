<?php $__env->startSection('title', 'AI Career Console - Dashboard'); ?>
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-900 pb-8">
            <div>
                ...
                <p class="text-slate-400 text-sm mt-2 font-light">
                    Welcome back, <span class="text-white font-semibold"><?php echo e(auth()->user()->name); ?></span>. Optimize your career assets with next-generation AI metrics.
                </p>
            </div>
            <div class="flex gap-3">
                <a href="<?php echo e(route('resume.import')); ?>" class="px-5 py-3 bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-800 text-sm font-bold rounded-2xl transition flex items-center gap-2">
                    <span>📥</span> Import Resume
                </a>
                <a href="<?php echo e(route('resume.templates')); ?>" class="px-5 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-2xl hover:opacity-95 active:scale-[0.98] transition shadow-lg shadow-blue-500/10 flex items-center gap-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-slate-900/40 border border-slate-850 p-6 rounded-3xl hover:border-slate-800/80 transition flex items-center justify-between group">
                <div class="space-y-1">
                    ...
                    <p class="text-3xl font-black text-white group-hover:text-blue-400 transition"><?php echo e($stats['totalResumes']); ?></p>
                </div>
            ...
            <div class="bg-slate-900/40 border border-slate-850 p-6 rounded-3xl hover:border-slate-800/80 transition flex items-center justify-between group">
                <div class="space-y-1">
                    ...
                    <p class="text-3xl font-black text-white group-hover:text-indigo-400 transition"><?php echo e($stats['totalPortfolios']); ?></p>
                </div>
            ...
            <div class="bg-slate-900/40 border border-slate-850 p-6 rounded-3xl hover:border-slate-800/80 transition flex items-center justify-between group">
                <div class="space-y-1">
                    ...
                    <p class="text-3xl font-black text-white group-hover:text-purple-400 transition">
                        <?php echo e($averageScore > 0 ? $averageScore . '%' : 'N/A'); ?>
            ...
            <div class="bg-slate-900/40 border border-slate-850 p-6 rounded-3xl hover:border-slate-800/80 transition flex items-center justify-between group">
                <div class="space-y-1">
                    ...
                    <p class="text-3xl font-black text-white group-hover:text-rose-400 transition"><?php echo e($stats['exports']); ?></p>
                </div>
            ...
            <div class="lg:col-span-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $resumes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resume): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-slate-900/30 border border-slate-850 p-6 rounded-3xl space-y-5 hover:border-slate-800 transition duration-300 flex flex-col justify-between group">
                                <div class="space-y-2">
                                    <div class="flex items-center justify-between">
                                        <h3 class="font-bold text-white text-lg group-hover:text-blue-400 transition"><?php echo e($resume->title); ?></h3>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resume->ai_score): ?>
                                            <span class="px-2.5 py-0.5 bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] font-bold rounded-full uppercase tracking-wider font-mono">
                                                ★ <?php echo e($resume->ai_score); ?> Score
                                            </span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                    <p class="text-xs text-slate-400 font-light">Last revised <?php echo e($resume->updated_at->diffForHumans()); ?> // v<?php echo e($resume->version); ?></p>
                                </div>
                                
                                <div class="flex gap-2">
                                    <a href="<?php echo e(route('resume.edit', $resume)); ?>" class="flex-1 py-2.5 text-center bg-slate-850 hover:bg-blue-600 text-white rounded-xl text-xs font-bold transition shadow-sm">
                                        Edit
                                    </a>
                                    <a href="<?php echo e(route('resume.score', $resume)); ?>" class="px-3.5 py-2.5 bg-slate-900 border border-slate-800 text-slate-300 rounded-xl text-xs font-bold hover:border-indigo-500 hover:text-white transition">
                                        📈 Score
                                    </a>
                                    <a href="<?php echo e(route('resume.preview', $resume)); ?>" class="px-3.5 py-2.5 bg-slate-900 border border-slate-800 text-slate-350 rounded-xl text-xs font-bold hover:border-slate-700 hover:text-white transition">
                                        Preview
                                    </a>
                                </div>
                            </div>
                ...
                <?php else: ?>
                    <div class="text-center py-16 bg-slate-900/10 border border-dashed border-slate-850 rounded-3xl p-8 space-y-4">
                        ...
                        <a href="<?php echo e(route('resume.templates')); ?>" class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition inline-block">
            ...
            <div class="lg:col-span-4 space-y-6">
                    ...
                    <div class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $portfolios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portfolio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-slate-900/30 border border-slate-850 p-5 rounded-2xl flex items-center justify-between hover:border-slate-800 transition">
                                <div>
                                    <h4 class="font-bold text-white text-sm"><?php echo e($portfolio->title); ?></h4>
                                    <p class="text-[10px] text-slate-400 mt-1 uppercase font-semibold font-mono"><?php echo e($portfolio->template->name); ?></p>
                                </div>
                                <div class="flex gap-2">
                                    <a href="<?php echo e(route('portfolio.edit', $portfolio)); ?>" class="px-3 py-1.5 bg-slate-850 hover:bg-slate-800 text-slate-200 text-xs font-semibold rounded-lg transition border border-slate-750">Edit</a>
                                    <a href="<?php echo e(route('portfolio.preview', $portfolio)); ?>" class="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-lg transition">View</a>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php else: ?>
                    <div class="text-center py-12 bg-slate-900/10 border border-dashed border-slate-850 rounded-2xl p-6 space-y-3">
                        ...
                        <a href="<?php echo e(route('portfolio.create')); ?>" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-lg transition inline-block">
                            Generate Site
                        </a>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\OneDrive\Desktop\Resume Ai Builder\resources\views/dashboard/index.blade.php ENDPATH**/ ?>