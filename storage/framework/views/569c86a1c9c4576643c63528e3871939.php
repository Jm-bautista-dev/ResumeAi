<?php $__env->startSection('title', 'Edit Resume - ' . $resume->title); ?>

<?php $__env->startSection('content'); ?>
<script>
    window.initialResumeContent = <?php echo json_encode($resume->content, 15, 512) ?>;
</script>

<div class="min-h-screen bg-slate-950 text-slate-100" 
     x-data="resumeBuilder(<?php echo e($resume->id); ?>, window.initialResumeContent, '<?php echo e(addslashes($resume->title)); ?>')">
    ...
    <div class="border-b border-slate-800 bg-slate-900/50 backdrop-blur-md sticky top-[73px] z-30 px-6 py-4">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-4 w-full md:w-auto">
                <a href="<?php echo e(route('resume.index')); ?>" class="text-slate-400 hover:text-white transition">
                    &larr; Back
                </a>
            ...
            <div class="flex items-center gap-3 w-full md:w-auto justify-end">
                ...
                <a href="<?php echo e(route('resume.export-pdf', $resume)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\OneDrive\Desktop\Resume Ai Builder\resources\views/resume/edit.blade.php ENDPATH**/ ?>