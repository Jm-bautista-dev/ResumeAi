        ...
        <div class="relative px-6 py-32 mx-auto max-w-7xl">
            <div class="text-center">
                ...
                <div class="flex gap-4 justify-center flex-wrap">
                    <a href="<?php echo e(route('register')); ?>" class="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-purple-500/50 transition">
                        Get Started Free
                    </a>
                    <a href="<?php echo e(route('features')); ?>" class="px-8 py-3 border border-purple-400 text-white font-semibold rounded-lg hover:bg-purple-900/20 transition">
                        Learn More
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\OneDrive\Desktop\Resume Ai Builder\resources\views/landing.blade.php ENDPATH**/ ?>